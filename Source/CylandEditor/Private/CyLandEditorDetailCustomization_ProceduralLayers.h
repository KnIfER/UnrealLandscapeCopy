...
class FCyLandEditorDetailCustomization_ProceduralLayers : public FCyLandEditorDetailCustomization_Base
{
public:
...
class FCyLandEditorCustomNodeBuilder_ProceduralLayers : public IDetailCustomNodeBuilder, public TSharedFromThis<FCyLandEditorCustomNodeBuilder_ProceduralLayers>
{
public:
	FCyLandEditorCustomNodeBuilder_ProceduralLayers(TSharedRef<FAssetThumbnailPool> ThumbnailPool);
	~FCyLandEditorCustomNodeBuilder_ProceduralLayers();
