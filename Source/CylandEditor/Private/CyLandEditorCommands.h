...
/**
 * Unreal CyLand editor actions
 */
class FCyLandEditorCommands : public TCommands<FCyLandEditorCommands>
{

public:
	FCyLandEditorCommands();
...
public:
	...
	// Tools
	TSharedPtr<FUICommandInfo> NewCyLand;
	TSharedPtr<FUICommandInfo> ResizeCyLand;
