...
FCyLandHeightmapFileFormat_Png::FCyLandHeightmapFileFormat_Png()
{
...
FCyLandHeightmapInfo FCyLandHeightmapFileFormat_Png::Validate(const TCHAR* HeightmapFilename) const
{
	...
	else
	{
		...
		else
		{
			...
			{
				Result.ResultCode = ECyLandImportResult::Warning;
...
FCyLandHeightmapImportData FCyLandHeightmapFileFormat_Png::Import(const TCHAR* HeightmapFilename, FCyLandFileResolution ExpectedResolution) const
{
...
void FCyLandHeightmapFileFormat_Png::Export(const TCHAR* HeightmapFilename, TArrayView<const uint16> Data, FCyLandFileResolution DataResolution, FVector Scale) const
{
	IImageWrapperModule& ImageWrapperModule = FModuleManager::LoadModuleChecked<IImageWrapperModule>("ImageWrapper");
	TSharedPtr<IImageWrapper> ImageWrapper = ImageWrapperModule.CreateImageWrapper(EImageFormat::PNG);
...
FCyLandWeightmapFileFormat_Png::FCyLandWeightmapFileFormat_Png()
{
...
FCyLandWeightmapInfo FCyLandWeightmapFileFormat_Png::Validate(const TCHAR* WeightmapFilename, FName LayerName) const
{
...
FCyLandWeightmapImportData FCyLandWeightmapFileFormat_Png::Import(const TCHAR* WeightmapFilename, FName LayerName, FCyLandFileResolution ExpectedResolution) const
{
...
void FCyLandWeightmapFileFormat_Png::Export(const TCHAR* WeightmapFilename, FName LayerName, TArrayView<const uint8> Data, FCyLandFileResolution DataResolution) const
{
	IImageWrapperModule& ImageWrapperModule = FModuleManager::LoadModuleChecked<IImageWrapperModule>("ImageWrapper");
	TSharedPtr<IImageWrapper> ImageWrapper = ImageWrapperModule.CreateImageWrapper(EImageFormat::PNG);
