...
#define LOCTEXT_NAMESPACE "CyLandEditorCommands"
DEFINE_LOG_CATEGORY_STATIC(CyLandEditorCommands, Log, All);
FName FCyLandEditorCommands::CyLandContext = TEXT("CyLandEditor");

FCyLandEditorCommands::FCyLandEditorCommands()
	: TCommands<FCyLandEditorCommands>
(
	FCyLandEditorCommands::CyLandContext, // Context name for fast lookup
	NSLOCTEXT("Contexts", "CyLandEditor", "Copied Landscape Editor"), // Localized context name for displaying
	NAME_None, //"LevelEditor" // Parent
	FEditorStyle::GetStyleSetName() // Icon Style Set
	)
{
	auto mName = FEditorStyle::GetStyleSetName();
	UE_LOG(CyLandEditorCommands, Warning, TEXT("FCyLandEditorCommands %s "), *mName.ToString());
}

void FCyLandEditorCommands::RegisterCommands()
{
	...
	UI_COMMAND(NewCyLand, "Tool - New CyLand", "", EUserInterfaceActionType::RadioButton, FInputChord());
	NameToCommandMap.Add("Tool_NewCyLand", NewCyLand);

	UI_COMMAND(ResizeCyLand, "Tool - Change Component Size", "", EUserInterfaceActionType::RadioButton, FInputChord());
	NameToCommandMap.Add("Tool_ResizeCyLand", ResizeCyLand);
	...
	UI_COMMAND(MoveToLevelTool, "Tool - Move to Level", "Moves the selected CyLand components to the current streaming level", EUserInterfaceActionType::RadioButton, FInputChord());
