...
/**
 * Slate widgets customizer for the "Change CyLand Component Size" tool
 */

class FCyLandEditorDetailCustomization_ResizeCyLand : public FCyLandEditorDetailCustomization_Base
{
public:
...
public:
	...
	static FText GetOriginalCyLandResolution();
	static FText GetCyLandResolution();
