...
#include "MaterialExpressionCyLandLayerSwitch.generated.h"

class UTexture;
struct FMaterialParameterInfo;

UCLASS(collapsecategories, hidecategories=Object)
class CYLAND_API UMaterialExpressionCyLandLayerSwitch : public UMaterialExpression
{
	...
	UPROPERTY(EditAnywhere, Category=MaterialExpressionCyLandLayerSwitch)
	FName ParameterName;
