...
#include "CyLandGrassType.generated.h"

class UStaticMesh;
struct FPropertyChangedEvent;

UENUM()
enum class ECyGrassScaling : uint8
{
...
struct FCyGrassVariety
{
	...
	FCyGrassVariety()
		...
		, MinLOD(-1)
		, Scaling(ECyGrassScaling::CyUniform)
		, ScaleX(1.0f, 1.0f)
		, ScaleY(1.0f, 1.0f)
		, ScaleZ(1.0f, 1.0f)
		, RandomRotation(true)
		, AlignToSurface(true)
		, bUseCyLandLightmap(false)
...
UCLASS(MinimalAPI)
class UCyLandGrassType : public UObject
{
	GENERATED_UCLASS_BODY()

	UPROPERTY(EditAnywhere, Category = Grass)
	TArray<FCyGrassVariety> GrassVarieties;
