...
/*=============================================================================
CyLandDataAccess.h: Classes for the editor to access to CyLand data
=============================================================================*/
...
//
// FCyLandDataInterface
//
struct FCyLandDataInterface
{
private:
...
//
// FCyLandComponentDataInterface
//
struct FCyLandComponentDataInterface
{
	friend struct FCyLandDataInterface;

	// tors
	CYLAND_API FCyLandComponentDataInterface(UCyLandComponent* InComponent, int32 InMipLevel = 0);
	CYLAND_API ~FCyLandComponentDataInterface();
...
//#endif
	...
	CYLAND_API void GetHeightmapTextureData(TArray<FColor>& OutData, bool bOkToFail = false);

	CYLAND_API bool GetWeightmapTextureData(UCyLandLayerInfoObject* LayerInfo, TArray<uint8>& OutData);
	...
	CYLAND_API FColor* GetXYOffsetData(int32 LocalX, int32 LocalY) const;
	...
	CYLAND_API FVector GetLocalVertex(int32 LocalX, int32 LocalY) const;
	...
	CYLAND_API FVector GetWorldVertex(int32 LocalX, int32 LocalY) const;

	CYLAND_API void GetWorldTangentVectors(int32 LocalX, int32 LocalY, FVector& WorldTangentX, FVector& WorldTangentY, FVector& WorldTangentZ) const;

	CYLAND_API void GetWorldPositionTangents(int32 LocalX, int32 LocalY, FVector& WorldPos, FVector& WorldTangentX, FVector& WorldTangentY, FVector& WorldTangentZ) const;
...
private:
	FCyLandDataInterface DataInterface;
